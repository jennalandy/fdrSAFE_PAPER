---
title: "fdrSAFE on Platinum Spike Dataset - Dataset"
author: "Jenna Landy"
date: "2025-09-13"
format:
  pdf
...
```{r}
y = as.factor(colnames(expression_per_sample_FILTERED))
t_statistics = sapply(
  1:nrow(expression_per_sample_FILTERED), 
  function(i) {
    test = t.test(expression_per_sample_FILTERED[i,y == 'A'], expression_per_sample_FILTERED[i,y == 'B'])
    return(test$statistic)
  }
)

hist(t_statistics, main = "Test Statistics")
```
...
save(platinum_data, file = file.path(data_dir, "1_platinum_data.RData"))
```
